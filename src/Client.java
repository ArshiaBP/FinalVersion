            ...
            while (!(order.toLowerCase(Locale.ROOT).equals("#exit"))) {
                ...
                //#create chat name in server n
                    ...
                    try {
                        ...
                        int serverId = Integer.parseInt(order, i + 11, order.length(), 10);
                ...
                //add user (name) to chat m
                    ...
                    try {
                        ...
                        int chatId = Integer.parseInt(order, i + 9, order.length(), 10);
                ...
                //#show messages of chat n
                    ...
                    try {
                        int chatId = Integer.parseInt(order, 23, order.length(), 10);
                ...
                //#send message to chat n: message
                    ...
                    try {
                        ...
                        int chatId = Integer.parseInt(order, 22, i, 10);
                ...
                //#edit message n chat m: newMessage
                    ...
                    try {
                        ...
                        int messageId = Integer.parseInt(order, 14, i, 10);
                        int j = i + 6;
                        i = j;
                        while (order.charAt(i) != ':') {
                            i++;
                        }
                        int chatId = Integer.parseInt(order, j, i, 10);
                        i += 2;
                ...
                //#reaction to message n chat m
                    ...
                    try {
                        ...
                        int messageId = Integer.parseInt(order, 21, i, 10);
                        i += 6;
                        int chatId = Integer.parseInt(order, i, order.length(), 10);
                ...
                //#pin message n chat m
                    ...
                    try {
                        ...
                        int messageId = Integer.parseInt(order, 13, i, 10);
                        i += 6;
                        int chatId = Integer.parseInt(order, i, order.length(), 10);
                ...
                //check
                    ...
                    try {
                        ...
                        int messageId = Integer.parseInt(order, 16, i, 10);
                        i += 6;
                        int chatId = Integer.parseInt(order, i, order.length(), 10);
                ...
                //#show admins of chat n
                    ...
                    try {
                        int chatId = Integer.parseInt(order, 21, order.length(), 10);
                ...
                //#show users in voiceChat n
                    ...
                    try {
                        int chatId = Integer.parseInt(order, 25, order.length(), 10);
                ...
                //#show users of chat n
                    ...
                    try {
                        int chatId = Integer.parseInt(order, 20, order.length(), 10);
                ...
                //#remove admin name from chat n
                    ...
                    try {
                        ...
                        int chatId = Integer.parseInt(order, i + 11, order.length(), 10);
                ...
                //#remove admin name from sever n
                    ...
                    try {
                        ...
                        String username = order.substring(14, i);
                        int admin = dataBase.determineId(username);
                        int serverId = Integer.parseInt(order, i + 12, order.length(), 10);
                ...
                //#send message to privateChat n: message
                    ...
                    try {
                        ...
                        int privateChatId = Integer.parseInt(order, 29, i, 10);
                        String message = order.substring(i + 2);
                ...
                //#edit message n privateChat m: newMessage
                    ...
                    try {
                        ...
                        int privateChatId = Integer.parseInt(order, j, i, 10);
                        i += 2;
                        String message = order.substring(i);
                ...
                //#show messages of privateChat n
                    ...
                    try {
                        int privateChatId = Integer.parseInt(order, 30, order.length(), 10);
                ...
                //#add me to voiceChat n
                    ...
                    try {
                        int voiceChatId = Integer.parseInt(order, 21, order.length(), 10);
                ...
                //#leave voiceChat n
                    ...
                    try {
                        int voiceChatId = Integer.parseInt(order, 17, order.length(), 10);
                ...
                //#add user (name) to voiceChat n
                    ...
                    try {
                        ...
                        String username = order.substring(10, i);
                        int userId = dataBase.determineId(username);
                        int voiceChatId = Integer.parseInt(order, i + 14, order.length(), 10);
