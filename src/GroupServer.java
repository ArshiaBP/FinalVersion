...
public class GroupServer implements Serializable {
     ...
     */
    public ArrayList<Integer> getServerUsers() {
        return this.admins;
    }
     ...
     * Sets server users.
     *
     * @param serverUsers the server users
     */
    public void setServerUsers(ArrayList<Integer> serverUsers) {
        this.admins = serverUsers;
    }
